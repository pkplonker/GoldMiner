...
// 				prop.OverrideRadius = EditorGUILayout.Toggle("Override Ride Radius", prop.OverrideRadius);
// 				prop.InBounderyOnly = EditorGUILayout.Toggle("In Boundry Only", prop.InBounderyOnly);
//
// 				EditorGUILayout.Space();
// 			}
// 		}
